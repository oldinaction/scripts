...
# 法2(需要是raw类型的连接)
wget --no-check-certificate https://raw.githubusercontent.com/oldinaction/scripts/master/shell/prod/conf-recode-cmd-history.sh && bash conf-recode-cmd-history.sh 2>&1 | tee my.log
```